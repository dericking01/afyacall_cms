...
class CustomerUpdates implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;
    private $conventions_ID = null;
    /**
     * Create a new job instance.
     *
     * @return void
     */
    public function __construct($conventions_ID)
    {
        $this->conventions_ID = $conventions_ID;
    }
    ...
    {
        $transaction = Transaction::where("conventions_ID", $this->conventions_ID)->get()->first();
        if ($transaction) {
