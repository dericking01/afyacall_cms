...
@section('content')
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">General Reports for SMS</h4>
                <div class="row pt-3">
                    <!--/span-->
                    <div class="col-md-4">
                    ...
                    success: function(response) {
                        ...
                        var dataTable = $("#ticketreporttable").DataTable({
                            ...
                            buttons: [{
                                    ...
                                    filename: 'SMS Subscription Reports',
                                },
                                {
                                    extend: 'excel',
                            ...
                            columnDefs: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data) {
                                        if (data == 1) {
                                            return '<span class="badge badge-pill badge-success">Opt In</span>';
                                        } else if (data == 0) {
                                            return '<span class="badge badge-pill badge-warning">Opt Out</span>';
                                        } else {
                                            return '<span class="badge badge-pill badge-danger">Removed Out</span>';
                                        }
